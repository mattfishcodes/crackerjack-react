...
export default function Services() {
  return (
    <main>
      ...
      <Section>
        <div>
          Ready to Get Started? Invest in your business&apos;s success with a
          flexible hourly retainer package from Crackerjack Solutions. Contact
          us today to schedule your free consultation and discover how we can
          help you achieve your goals. Schedule Now Get access to a FREE 30
          minute call!
        </div>
      </Section>
      ...
      <Section>
        <div>
          Services Available Projects Create Detailed Project Plans Lead Initial
          Kickoff Call with Stakeholders Lead Regular Check In Calls Manage
          Communication, Timeline, Change Requests, Status and Deliverables
          Maximize Productivity, Quality and Stakeholder Satisfaction And more…
          Systems Manage Scheduling Manage Invoicing Manage Client Onboarding
          Review, Update and Create Processes Create SOPs & Playbooks for
          Systems And more… Operations Review and Optimize existing Business
          Processes and Tools Create SOPs and Playbooks for Operations Manage
          CRM, Email and Calendar Create and/or Update Automations Develop
          Digital File Systems And more…
        </div>
      </Section>

      <Section>
        <div>
          Software We use a variety of online apps/SaaS tools. Some of them are
          used daily and some weekly, others less often. However, we have not
          yet met a SaaS tool that we were not able to master! We learn quickly
          and love the challenge of learning a new tool. Here is a brief list of
          some of the tools we currently use or have used frequently: Airtable
          Asana Calendly Canva ClickUp Dubsado FormAssembly Gusto HubSpot
          LastPass Loom MailChimp Make Microsoft/Office 365 Miro Moxie
          QuickBooks Salesforce SiteGround Slack Stripe Payments TaskRay Trello
          WordPress Zapier Zoom
        </div>
      </Section>
    </main>
  )
