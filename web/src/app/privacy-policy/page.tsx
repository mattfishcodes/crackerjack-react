    ...
    <main>
      <Container>
        <div className='mb-8'>
          ...
          <p>
            This privacy policy will inform you how Crackerjack Solutions LLC
        ...
        <div className='mb-8'>
          ...
          <p>
            ...
            keeping it confidential. Crackerjack Solutions LLC has done all in
            its power to prevent data theft, unauthorized access, and disclosure
            by implementing the latest technologies and software, which help us
        ...
        <div className='mb-8'>
          ...
          <p>
            ...
            to allow us to use the data collected regarding your online behavior
            (analyze web traffic, web pages you visit and spend the most time
            on).
          </p>
          <p>
            ...
            wide variety of browsers and devices. If you disable cookies our
